...
template<class T> VIndex add_possible_duplicate_to_binary_vector(T ptr,svector<T> &vect)
{
...
template<class T> void remove_from_local_id_64_vector(T ptr,svector<T> &vect)
{
	int64_t start=0;
	int64_t end=(int64_t)vect.size()-1;
...
template<class T> T get_from_local_id_64_vector(int64_t id,svector<T> &vect)
{
	int64_t start=0;
	int64_t end=(int64_t)vect.size()-1;
...
template<class T> int64_t get_index_from_local_id_64_vector(int64_t id,svector<T> &vect)
{
	int64_t start=0;
	int64_t end=(int64_t)vect.size()-1;
